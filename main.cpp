...
int main(int argc, const char * argv[]) {
    ...
    // Path a video file
    string u_path_video = "/Users/yakup/Test_Input_Files/UD/testvideo640480.mp4";
...
void ProcessVideoWithFPGA(string videoFilename) {
    ...
    while( capture.read(frame) ){
        ...
        xf::Mat<IN_TYPE , HEIGHT, WIDTH, NPIX> S_channel(height, width);
        xf::Mat<OUT_TYPE, HEIGHT, WIDTH, NPIX> S_channel_threshold(height, width);
        ...
        xf::Mat<OUT_TYPE, HEIGHT, WIDTH, NPIX> L_channel_threshold(height, width);
        xf::Mat<OUT_TYPE, HEIGHT, WIDTH, NPIX> Bitwise_OR(height, width);
        xf::Mat<OUT_TYPE, HEIGHT, WIDTH, NPIX> Perspective(height, width);
        ...
        arithm_accel(L_channel_x, zero_image_xf , L_channel_sobelx_absolute, true); // L Channel Absolute
        ...
        arithm_accel(S_channel_threshold, L_channel_threshold, Bitwise_OR, false); //BitwiseOr
